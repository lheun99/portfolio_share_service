...
const EducationForm = (props) => {
    ...
    return (
        ...
        <Form.Group className="mb-3">
            ...
            <Form.Control type="text" name='school' value={schoolInput} onChange={changeHandler1} placeholder='학교 이름' />
        </Form.Group>

        <Form.Group className="mb-3">
            {/* <Form.Label>전공명</Form.Label> */}
            <Form.Control type='text' name='major' value={majorInput} onChange={changeHandler2} placeholder='전공' />
        </Form.Group>
        ...
        <div style={{textAlign: "center"}}>
            ...
            <Button size='sm' variant="danger"  style={{marginLeft: 8,}} onClick={() => props.clickHandler()}>
                취소
            </Button>
        </div>
        </Form>
