                  ...
                  <Col sm={{ span: 20 }}>
                    ...
                    <Modal show={show} style={{ zIndex: 99999 }}>
                      ...
                      <Modal.Footer style={{ justifyContent: "center" }}>
                        <Button variant="outline-danger" onClick={withdrawal}>
                          회원탈퇴
                        </Button>
                        <Button
                    ...
                    <Modal show={showConfirm} style={{ zIndex: 99999 }}>
                      <Modal.Header closeButton>
                        <Modal.Title>회원탈퇴가 완료되었습니다.</Modal.Title>
                      </Modal.Header>
                      <Modal.Body>그동안 이용해주셔서 감사합니다.</Modal.Body>
                      <Modal.Footer style={{ justifyContent: "center" }}>
                        <Button
                          variant="outline-info"
